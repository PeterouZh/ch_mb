...
extern "C"{
  ...
  {
    int min_face_size;      /*允许检测最小人脸大小*/
    int max_face_size;      /*允许检测最大人脸大小*/
    int slide_wnd_step_x;   /*滑动窗口x步长*/
    int slide_wnd_step_y;   /*滑动窗口y步长*/
		
    double pyramid_scale;      /*金字塔缩小尺度*/
    double score_thresh;       /*得分阈值*/
